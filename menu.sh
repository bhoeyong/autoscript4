...
echo -e "$merah ➢➢➢$kuning PHCORNER: N O T E"
echo -e "$merah ➢➢➢$merah GITHUB: Darkrenz"
echo -e "$merah ➢➢➢$blue Autoscript by ノート"
echo -e "$putih━━━━━━━━━━━━━━━━━━━━━━━MENU━━━━━━━━━━━━━━━━━━━━━━━"
...
echo -e "$merah 13$putih. Exit $biru(exit)"
echo -e "$merah 14$putih. Speedtest VPS $biru(speedtest)"
echo -e "$merah 15$putih. Displaying System Information $biru(info)"
echo -e "$merah 16$putih. Info Script Auto Install $biru(about)"
echo -e "$merah 17$putih. Customize your banner $biru(banner)"
echo -e 
echo -e ""
echo -e "$cyan Untuk keluar dari menu tekan$merah CTRL + C"
echo -e "$putih==============================================================="
